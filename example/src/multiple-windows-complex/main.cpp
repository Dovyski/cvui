...
int main(int argc, const char *argv[])
{
	...
	while (true) {
		...
		cvui::beginColumn(frame1, 300, 330, 100, 200, padding);
			...
			cvui::button("button1");
			cvui::button("button2");
			cvui::trackbar(150, &window1_value3, 0., 5., 1,3,4, "%3.2Lf", cvui::TRACKBAR_DISCRETE, 0.25);
		...
		cvui::beginColumn(frame2, 300, 330, 100, 200, padding);
			...
			cvui::button("button1");
			cvui::button("button2");
			cvui::trackbar(150, &window2_value3, 0., 5., 1, 3, 4, "%3.2Lf", cvui::TRACKBAR_DISCRETE, 0.25);
			cvui::text("End of column 2");
		cvui::endColumn();
