...
int main(int argc, const char *argv[])
{
	...
	while (true) {
		...
		cvui::beginColumn(frame, 20, 20, -1, -1, 6);
			...
			cvui::trackbar(&intValue1, cvui::trackbarParams_Ints(0, 100));
			cvui::text("");

			static int intValue2 = 30;
			cvui::text("Simple int trackbar, 5 large steps");
			cvui::trackbar(&intValue2, cvui::trackbarParams_Ints(0, 100, 5));
			cvui::text("");

			static double doubleValue1 = 30.;
			cvui::text("Simple float trackbar");
			cvui::text("1 decimal, no large step");
			cvui::trackbar(&doubleValue1, cvui::trackbarParams_Floats(10., 50., 1));
			cvui::text("");

			static double doubleValue2 = 30.;
			cvui::text("Simple float trackbar");
			cvui::text(" 2 decimals, 4 large Steps");
			cvui::trackbar(&doubleValue2, cvui::trackbarParams_Floats(10., 50., 2,  4, 1.));
			cvui::text("");
			...
			cvui::trackbar(&doubleValue3, cvui::trackbarParams_Floats(10., 10.5, 1, 1, 0.1, true));
