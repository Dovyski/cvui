...
int main(int argc, const char *argv[])
{
	...
	while (true) {
		...
		cvui::beginColumn(frame, 20, 20, -1, -1, 6);
			...
			cvui::trackbar(width, &doubleValue2, 10., 10.5, 1, "%.1Lf", cvui::TRACKBAR_DISCRETE, 0.1, 3, 4);
			cvui::space(5);

			cvui::text("double trackbar, label %.2Lf, 2 segments, TRACKBAR_DISCRETE");
			cvui::trackbar(width, &doubleValue3, 0., 4., 2, "%.2Lf", cvui::TRACKBAR_DISCRETE, 0.25, 3, 4);
			cvui::space(10);
