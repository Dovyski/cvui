...
int main(int argc, const char *argv[])
{
	...
	while (true) {
		...
		switch (status) {
			...
			case cvui::DOWN:	cvui::text(frame, 240, 50, "Mouse is: DOWN"); break;
			case cvui::OVER:	cvui::text(frame, 240, 50, "Mouse is: OVER"); break;
			case cvui::OUT:		cvui::text(frame, 240, 50, "Mouse is: OUT"); break;
		}
